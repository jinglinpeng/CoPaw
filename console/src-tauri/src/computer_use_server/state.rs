...
/// Select the observation sources needed by this call. Full observations stay
/// the default; callers may omit an unused source to avoid native work and
/// model context.
#[derive(Clone, Copy, Debug)]
pub(super) struct ObservationOptions {
    pub(super) include_screenshot: bool,
