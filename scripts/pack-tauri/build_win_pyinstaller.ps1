...
# Linux/macOS. The only way to redirect the NSIS cache is via LOCALAPPDATA.
# On Jenkins: avoids restricted system AppData profile.
# On local machines: provides an isolated workspace cache.
